...
class Phase3CExternalCaseSetupService:
    ...
    def _write_claims_guardrails(self) -> Path:
        ...
        lines = [
            ...
            "",
            "- Phase 3C tests transferability; it does not replace Mindoro as the main Philippine case.",
            "- Public observation-derived external masks remain the quantitative truth candidates for this external case.",
            "- PyGNOME remains a comparator, not truth.",
