...
- Provenance-only metadata added here: `manifests/prototype_2016_provenance_metadata.json` records the earliest shared initial capture box `[108.6465, 121.3655, 6.1865, 20.3515]` plus the three original source boxes, while keeping the stored case-local prototype extents unchanged
...
- Copied artifacts: 168
- Regenerated metadata/display artifacts: 55
- Flat per-case compatibility figures retained: 42
