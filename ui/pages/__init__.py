...
PAGE_DEFINITIONS = [
    ...
    PageDefinition("mindoro_validation", "Primary Mindoro March 13-14 Validation Case (B1)", mindoro_validation.render, navigation_section="Final Paper Evidence", url_path="mindoro-b1-public-observation-validation"),
    PageDefinition("cross_model_comparison", "Mindoro Same-Case OpenDrift-PyGNOME Comparator (Track A)", cross_model_comparison.render, navigation_section="Final Paper Evidence", url_path="mindoro-track-a-comparator-support"),
    ...
    PageDefinition("legacy_2016_support", "Secondary 2016 Drifter-Track And Legacy FSS Support", legacy_2016_support.render, navigation_section="Final Paper Evidence", url_path="secondary-2016-support"),
